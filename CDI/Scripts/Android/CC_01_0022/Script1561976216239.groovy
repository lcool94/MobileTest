...
// TC 0022
// 1. 「ユーザー登録」画面を表示する
// 2. デフォルトで設定されている名称をすべて削除する
// 3. 任意のユーザー名を入力する
// デフォルトの名称を削除すると、ユーザー名を入力するフィールドであることがわかる表示がされること
// 任意の値が入力可能なこと
...
'input "" into Username'
Mobile.sendKeys(findTestObject('Object Repository/Android/User_Setting/tv_Username'), "")
