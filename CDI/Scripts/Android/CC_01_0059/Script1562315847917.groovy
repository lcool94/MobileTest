...
'Tap Confirm Group Setting'
Mobile.tap(findTestObject('Object Repository/Android/Group_Setting/tv_Confirm'), 0)

Mobile.delay(5)

Mobile.scrollToText('Create new button')

'tap button Create new button'
Mobile.tap(findTestObject('Object Repository/Android/Group_Setting/bt_AddGroup'), 0)

Mobile.delay(2)

'CHECKPOINT: tv Create smart button'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Create_Smart_Button/tv_Create smart button'), 0), 'Create smart button', false)

'CHECKPOINT: tv Create new'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Create_Smart_Button/tv_Create new'), 0), 'Create new', false)

'CHECKPOINT: tv Recommend button'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Create_Smart_Button/tv_Recommend button'), 0), 'Recommend button', false)

'CHECKPOINT: tv "There are templates that matches your life scene. You can make smart buttons by the simple way."'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Create_Smart_Button/tv_There are...'), 0), 'There are templates that matches your life scene. You can make smart buttons by the simple way.', false)
