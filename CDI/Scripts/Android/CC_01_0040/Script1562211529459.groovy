...
// 1. 「新規部屋作成」ダイアログを表示する
// 2. 任意の部屋名を入力した状態で「キャンセル」ボタンをタップする"
...
Mobile.sendKeys(findTestObject('Object Repository/Android/Group_Setting/tv_Group name'), 'AutomationTest - 「新規部屋作成」')

Mobile.takeScreenshot()

'tap button Cancel'
Mobile.tap(findTestObject('Object Repository/Android/Group_Setting/tv_Cancel'), 0)
