...
// 1. 「新規部屋作成」ダイアログの表示を確認する

// 正しく表示されていること
// ※誤字・脱字、見キレ、翻訳されていない箇所、翻訳の不備等がないこと
// 部屋名を入力するフィールドであることがわかる表示がされていること
...
'CHECKPOINT: Add group'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting/tv_Add group'), 0), txt_Add_group, false)

'CHECKPOINT: Group name'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting/tv_Group name'), 0), txt_Group_name, false)

'CHECKPOINT: Cancel'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting/tv_Cancel'), 0), txt_Cancel, false)

'CHECKPOINT: Save'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting/tv_Save'), 0), txt_Save, false)
