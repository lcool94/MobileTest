...
// 2. ごみ箱アイコンをタップする
// 3. 確認ダイアログの「はい」をタップする

// 削除が行われ「デバイスの部屋割り当て」画面へ遷移すること
// 削除した部屋が一覧から消去されていること
...
'Tap YES'
Mobile.tap(findTestObject('Android/Group_Setting_Details/bt_YES'), 0)

Mobile.delay(5)

'CHECKPOINT: Not exist item Auto'
Mobile.verifyElementNotExist(findTestObject('Android/Group_Setting/tv_Item_Auto'), 0)
