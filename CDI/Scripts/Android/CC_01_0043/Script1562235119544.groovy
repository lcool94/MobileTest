...
// 1. 「デバイスの部屋割り当て 詳細」画面の表示を確認する
// 正しく表示されていること
// ※誤字・脱字、見キレ、翻訳されていない箇所、翻訳の不備等がないこと
// アカウントに接続されている対応デバイスのすべてが表示されていること
...
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting_Details/tv_Name'), 0), 'Auto', false)

'CHECKPOINT: Value in txt Group name'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting_Details/tv_Edit'), 0), 'Edit', false)
...
findTestObject('Object Repository/Android/Group_Setting_Details/tv_Name')
