...
// 2. ごみ箱アイコンをタップする
// 3. 確認ダイアログの「いいえ」をタップする

// ダイアログが閉じられ「デバイスの部屋割り当て 詳細」画面へ遷移すること
...
'Tap Delete icon'
Mobile.tap(findTestObject('Android/Group_Setting_Details/tv_Delete'), 0)

Mobile.delay(2)

'Tap button No'
Mobile.tap(findTestObject('Android/Group_Setting_Details/bt_NO'), 0)

Mobile.delay(2)

'CHECKPOINT: Screen Group Setting details'
