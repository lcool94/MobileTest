...
'input text into Group name'
Mobile.sendKeys(findTestObject('Object Repository/Android/Group_Setting/tv_Group name'), 'AutomationTest')


'CHECKPOINT: Value in txt Group name'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting/tv_Group name'), 0), 'AutomationTest', false)
