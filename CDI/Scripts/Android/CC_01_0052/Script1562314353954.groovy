...
'CHECKPOINT: Smart button'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Smart_Button/tv_Smart button'), 0), 'Smart button', false)

'CHECKPOINT: tv Humidity'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Smart_Button/tv_Humidity'), 0), 'Humidity', false)

'CHECKPOINT: tv Illumination'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Smart_Button/tv_Illumination'), 0), 'Illumination', false)

'CHECKPOINT: tv emperature'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Smart_Button/tv_Temperature'), 0), 'Temperature', false)

'CHECKPOINT: tv 家電コントローラー'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Smart_Button/tv_Weather'), 0), '家電コントローラー', false)
