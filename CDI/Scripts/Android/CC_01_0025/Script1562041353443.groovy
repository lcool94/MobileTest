...
'CHECKPOINT: textview Group Setting'
Mobile.verifyMatch(Mobile.getText(findTestObject('Object Repository/Android/Group_Setting/tv_Group Setting'), 0), txt_GroupSetting, false)
